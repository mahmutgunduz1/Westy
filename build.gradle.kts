// Top-level build file where you can add configuration options common to all sub-projects/modBuild file 'C:\Users\gndz1\Westy\build.gradle.kts' line: 2
//
...
//	at org.gradle.kotlin.dsl.provider.PluginRequestsHandler.handle(PluginRequestsHandler.kt:42)
...
//
//>> Ask Gemini Plugin [id: 'com.android.application', version: '8.5.1', apply: false] was not found in any of the following sources:ules.
plugins {
